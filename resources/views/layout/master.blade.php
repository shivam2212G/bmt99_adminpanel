...
<head>
    ...
    <title>@yield('title') | Vuexy - Bootstrap Admin Template</title>
        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item {{ request()->routeIs('categories.delete','categories.update','categories.edit','categories.store','categories.create','categories.index') ? 'active' : '' }}">
                        <a href="{{route('categories.index')}}" class="menu-link">
                            <i class="menu-icon tf-icons ti ti-mail"></i>
                            <div data-i18n="Category">Category</div>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->routeIs('subcategories.delete','subcategories.update','subcategories.edit','subcategories.store','subcategories.create','subcategories.index') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->routeIs('feature_brands.delete','feature_brands.update','feature_brands.edit','feature_brands.store','feature_brands.create','feature_brands.index') ? 'active' : '' }}">
                        <a href="{{route('feature_brands.index')}}" class="menu-link">
                            <i class="menu-icon tf-icons ti ti-mail"></i>
                            <div data-i18n="Feature Brands">Feature Brands</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item {{ request()->routeIs('order.list','order.details') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->routeIs('notifications.index','notifications.update') ? 'active' : '' }}">
                    ...
                    <li class="menu-item {{ request()->routeIs('sliders.delete','sliders.update','sliders.edit','sliders.store','sliders.create','settings.index') ? 'active' : '' }}">
                                    ...
                                    <div class="dropdown-shortcuts-list scrollable-container">
                                        ...
                                        <div class="row row-bordered overflow-visible g-0">
                                            <div class="dropdown-shortcuts-item col">
                                                ...
                                                <a href="{{ url('app-user-list.html') }}" class="stretched-link">User
                                                    App</a>
                                        ...
                                        <div class="row row-bordered overflow-visible g-0">
                                            <div class="dropdown-shortcuts-item col">
                                                ...
                                                <a href="{{ url('pages-faq.html') }}" class="stretched-link">FAQs</a>
